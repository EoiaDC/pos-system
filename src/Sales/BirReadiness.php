...
class BirReadiness
{
    ...
    public static function isCompanyProfileComplete(): bool
    {
        ...
        $stmt = self::$db->query("SELECT COUNT(*) FROM company_profile WHERE id = 1");
    ...
    {
        return [
            'company_profile_complete' => self::isCompanyProfileComplete(),
            'has_active_register' => self::hasActiveRegister(),
            'has_active_or_series' => self::hasActiveOrSeries(),
            'ready_for_sales' => self::isCompanyProfileComplete() && 
